...
<div class="control-group">
    ...
    <div class="controls">
		<input type="text" id="{{id}}-location" name="{{id}}-location" placeholder="Name of a station (ex. Gent Sint-Pieters)" class='input-block-level nmbs-location' value="{{location}}"/>
	</div>
</div>
<div class="control-group">
